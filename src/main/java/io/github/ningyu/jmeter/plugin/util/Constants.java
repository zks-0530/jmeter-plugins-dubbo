...
public class Constants {
    ...
    public static final String REGISTRY_JSF = "jsfRegistry";
    ...
    public static final String DEFAULT_ALAIS = "dubhe-1.0.0-zd_dev1";
    ...
    public static final String FIELD_JSF_ALIAS = "FIELD_JSF_ALIAS";
    ...
    public static final String getAlias(TestElement element) {
        return element.getPropertyAsString(FIELD_JSF_ALIAS, DEFAULT_VERSION);
    }
     ...
     */
    public static final void setAlias(String version, TestElement element) {
        element.setProperty(new StringProperty(FIELD_JSF_ALIAS, StringUtils.trimAllWhitespace(version)));
    }
    /**
     * set version
     * @param version the version to set
